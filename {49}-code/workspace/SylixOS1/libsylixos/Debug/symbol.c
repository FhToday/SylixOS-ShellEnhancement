...
extern int  chmodMatch(); 
extern int  isEmpty(); 
extern int  linksMatch(); 
extern int  mtimeMatch(); 
extern int  nameMatch(); 
extern int  sed_aic(); 
extern int  sed_d$(); 
extern int  sed_d2(); 
extern int  sed_d3(); 
...
extern int  sed_w4(); 
extern int  sed_y3(); 
extern int  sizeMatch(); 
extern int  strrpc(); 
extern int  strrpc_1(); 
extern int  typeMatch(); 
extern int  wildCard(); 
extern int  getopt(); 
...
SYMBOL_TABLE_BEGIN										
    ...
    SYMBOL_ITEM_FUNC(chmodMatch) 
    SYMBOL_ITEM_FUNC(isEmpty) 
    SYMBOL_ITEM_FUNC(linksMatch) 
    SYMBOL_ITEM_FUNC(mtimeMatch) 
    SYMBOL_ITEM_FUNC(nameMatch) 
    SYMBOL_ITEM_FUNC(sed_aic) 
    SYMBOL_ITEM_FUNC(sed_d$) 
    SYMBOL_ITEM_FUNC(sed_d2) 
    SYMBOL_ITEM_FUNC(sed_d3) 
    SYMBOL_ITEM_FUNC(sed_p2) 
    SYMBOL_ITEM_FUNC(sed_p3) 
    SYMBOL_ITEM_FUNC(sed_q2) 
    SYMBOL_ITEM_FUNC(sed_r$) 
    SYMBOL_ITEM_FUNC(sed_r3) 
    SYMBOL_ITEM_FUNC(sed_s) 
    SYMBOL_ITEM_FUNC(sed_w3) 
    SYMBOL_ITEM_FUNC(sed_w4) 
    SYMBOL_ITEM_FUNC(sed_y3) 
    SYMBOL_ITEM_FUNC(sizeMatch) 
    SYMBOL_ITEM_FUNC(strrpc) 
    SYMBOL_ITEM_FUNC(strrpc_1) 
    SYMBOL_ITEM_FUNC(typeMatch) 
    SYMBOL_ITEM_FUNC(wildCard) 
    ...
    SYMBOL_ITEM_FUNC(API_TShellParaAdd) 
    ...
    SYMBOL_ITEM_FUNC(addBlack) 
    SYMBOL_ITEM_FUNC(completeCmd) 
    SYMBOL_ITEM_FUNC(isPrefix) 
    SYMBOL_ITEM_FUNC(__tshellSysCmdInit) 
